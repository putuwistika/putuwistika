      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm md:text-base text-gray-400 mb-6"> <b>Adaptive</b>. <b>Integrity</b>. <b>Humble</b>.</p>
        ...
        <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-gray-500 text-center">
          <p className="text-sm md:text-base text-gray-400">&copy; {new Date().getFullYear()} Putu Ferry Wistika. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
